...
class CompanyMaster(db.Document):
    ...
    # Daraz API Settings
    daraz_app_key = db.StringField()
    daraz_app_secret = db.StringField()
    daraz_access_token = db.StringField()
    daraz_refresh_token = db.StringField()
    daraz_token_expiry = db.DateTimeField()
